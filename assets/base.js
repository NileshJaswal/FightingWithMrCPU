...
document
  .querySelectorAll(".modal .modal-action .btn")[0]
...
for (i of movesbtns) {
  i.addEventListener("click", function () {
    ...
    if (usermove === cpu) {
      ...
      document
        .querySelectorAll(".points .p1 .progress")[0]
        .setAttribute("value", p1_hp);
      document
        .querySelectorAll(".points .p2 .progress")[0]
        .setAttribute("value", cpu_hp);
      ...
      document.getElementById("cpustatus").innerHTML =
        "CPU 1 Used Super Special Counter";
      p1_hp = p1_hp - 30;
      document.querySelectorAll(".points .p1 span")[0].innerHTML = p1_hp;
      document
        .querySelectorAll(".points .p1 .progress")[0]
